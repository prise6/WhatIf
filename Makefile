...
pre_publish:
	$(RSCRIPT_INTERPRETER) -e "rmarkdown::render('Md/01-compare-groups-and-visualisation.md', output_format='github_document', output_file='01-compare-groups-and-visualisation.html', output_dir='public_html', knit_root_dir = '~/Projets/WhatIf/Md')"
	$(RSCRIPT_INTERPRETER) -e "rmarkdown::render('README.md', output_format='github_document', output_file='index.html', output_dir='public_html', output_options = list(self_contained = T))"
